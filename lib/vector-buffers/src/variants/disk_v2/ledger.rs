...
impl ArchivedLedgerState {
    ...
    pub unsafe fn unsafe_set_reader_last_record_id(&self, id: u64) {
        ...
        // reader.
        //
        // This is exclusively used under test to place the reader's last-read record ID at a
        // specific point (e.g. just before a deliberately-corrupted record) so initialization-seek
        // edge cases can be exercised without writing an impractical number of records.
