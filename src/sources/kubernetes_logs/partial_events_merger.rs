...
mod test {
    ...
    async fn merge_single_event_legacy() {
        ...
        let output_stream =
            merge_partial_events(input_stream, LogNamespace::Legacy, None, OversizedAction::Drop);
    ...
    async fn merge_single_event_vector_namespace() {
        ...
        let input_stream = futures::stream::iter([e_1.into()]);
        let output_stream =
            merge_partial_events(input_stream, LogNamespace::Vector, None, OversizedAction::Drop);
